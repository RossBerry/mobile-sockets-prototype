...
class MonoPackageManager_Resources {
	public static final String[] Assemblies = new String[]{
		/* We need to ensure that "SocketsPrototype.Android.dll" comes first in this list. */
		"SocketsPrototype.Android.dll",
		"FormsViewGroup.dll",
		"Newtonsoft.Json.dll",
		"Rssdp.dll",
		"Sockets.Plugin.Abstractions.dll",
		"Sockets.Plugin.dll",
		"SocketsPrototype.dll",
		...
		"SocketsPrototype.Models.dll",
		"SocketsPrototype.Services.dll",
	};
